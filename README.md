...
Yellow areas represent lower transport deprivation, while darker oranges and reds represent higher levels of transport poverty. The bar gives you an understanding of how severe the transport challenges are across different neighbourhoods.

When I hover over any LSOA, a tooltip appears displaying the LSOA code, the neighbourhood name, its local authority, and its exact Transport Poverty Index score. This allows us to explore each area in detail.

The black dots you see on the map highlight the Top 10 transport poverty hotspots in all of Lancashire.

If I hover over a dot, a bold label appears showing the hotspot’s rank, the local authority, and the LSOA name.

Clicking on the dot opens a popup with even more detail, including the precise Tranport Poverty Index value.

To make the map easier to interpret, I've drawn local authority boundaries in thick black lines.
